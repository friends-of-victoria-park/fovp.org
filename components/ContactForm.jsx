			...
			<form className="w-full max-w-lg" action="https://api.web3forms.com/submit" method="POST">
				...
				<div className="flex flex-wrap -mx-3 mb-6">
					<div className="w-full px-3 mb-6 md:mb-0">
						...
						<input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-full-name" type="text" name="subject" required />
					</div>
				</div>
				<div className="flex flex-wrap -mx-3 mb-6">
					<div className="w-full px-3">
