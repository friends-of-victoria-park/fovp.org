  ...
  return (
    <div>
        ...
        <div class="relative w-full h-[40rem]">
            <div class="w-full h-full bg-[url('/VP_DAYCAMP_BACK.jpg')] bg-cover bg-center " />
            <div
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center">
                <h1 class="mt-5 text-center text-4xl text-white font-semibold drop-shadow-lg">
                    Friends of Victoria Park
                </h1>
                <h1 class="mt-2 text-center text-4xl text-white font-semibold drop-shadow-lg">
                    Summer Day Camp Program
                </h1>
                <div class="mt-5 text-center text-1xl text-white drop-shadow-lg block p-6 max-w-4xl rounded-lg border shadow-md bg-gray-800 border-gray-700"> 
        ...
        <div class="relative w-full min-h-[40rem] bg-blue-100 grid grid-cols-1 gap-4 content-center place-items-center">
            <div class="px-6 py-6">
                <a class="block p-6 max-w-4xl bg-white rounded-lg border border-gray-200 shadow-md">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">The Program</h5>
                    <ul class="font-normal text-gray-700 drop-shadow-lg"> 
                ...
                <div class="pt-5">
                    <a class="block p-6 max-w-4xl bg-white rounded-lg border border-gray-200 shadow-md">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">How to Register</h5>
                        <ul class="font-normal text-gray-700 drop-shadow-lg"> 
